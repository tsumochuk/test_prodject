        ...
        return array(
            'factories' => array(
                ...
                'navigation' => function(HelperPluginManager $pm) {
					...
					$acl = new \AclNavigation\Acl\Acl($config);
...
//					$acl->allow('member', 'AuthDoctrine\Controller\Index');
					...
					$role = \AclNavigation\Acl\Acl::DEFAULT_ROLE; // The default role is guest $acl
// Without Doctrine
					if ($auth->hasIdentity()) {
						...
						switch ($usrl_id) {
							case 1 :
								$role = \AclNavigation\Acl\Acl::DEFAULT_ROLE; // guest
								break;
							case 2 :
								$role = 'member';
								break;
